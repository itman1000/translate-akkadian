...
## 3) Kaggle 用 override config を生成（fp16 前提）
...
## 4) コンペ train.csv を文単位に整形（aligned_train 作成）
...
## 6) （任意）test へ推論して submission.csv を作る
